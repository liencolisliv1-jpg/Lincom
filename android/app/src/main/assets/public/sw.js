...
self.addEventListener('fetch', (event) => {
  ...
  // Avoid caching websocket, chrome-extension or external analytics
  if (url.protocol.startsWith('chrome') || url.protocol.startsWith('ws')) {
    return;
  }
  ...
  event.respondWith(
    fetch(event.request)
      ...
      .catch(async () => {
        ...
        // Return an offline synthetic response if nothing in cache
        return new Response(
